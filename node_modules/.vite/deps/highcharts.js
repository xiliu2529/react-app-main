    ...
    (function(aa, K) {
      ...
      K(g, "Core/Utilities.js", [g["Core/Globals.js"]], function(a) {
        ...
        function x(b2, f2) {
          var z = {};
          E(b2, function(c2, q) {
            if (H(b2[q], true) && !b2.nodeType && f2[q]) c2 = x(b2[q], f2[q]), Object.keys(c2).length && (z[q] = c2);
            else if (H(b2[q]) || b2[q] !== f2[q] || q in b2 && !(q in f2)) z[q] = b2[q];
          });
          return z;
        }
        function F(b2, f2) {
        ...
        function I(b2, c2, n2) {
          var z = a.getStyle || I;
          if ("width" === c2) return c2 = Math.min(b2.offsetWidth, b2.scrollWidth), n2 = b2.getBoundingClientRect && b2.getBoundingClientRect().width, n2 < c2 && n2 >= c2 - 1 && (c2 = Math.floor(n2)), Math.max(0, c2 - (z(b2, "padding-left", true) || 0) - (z(b2, "padding-right", true) || 0));
          if ("height" === c2) return Math.max(0, Math.min(b2.offsetHeight, b2.scrollHeight) - (z(b2, "padding-top", true) || 0) - (z(
            b2,
            "padding-bottom",
            true
          ) || 0));
        ...
        function E(b2, f2, c2) {
          for (var z in b2) Object.hasOwnProperty.call(b2, z) && f2.call(c2 || b2[z], b2[z], z, b2);
        }
        function L(b2, f2, c2) {
          function z(f3, c3) {
          ...
          function q(c3) {
            ...
            if (b2.nodeName) {
              ...
              E(q2, function(b3, f3) {
                if (c3[f3]) for (v = c3[f3].length; v--; ) z(f3, c3[f3][v].fn);
              });
            }
          }
        ...
        function y(b2, f2, c2, J) {
          ...
          if (w.createEvent && (b2.dispatchEvent || b2.fireEvent && b2 !== a)) {
            ...
            z = [];
            for (var q = b2, n2 = false; q.hcEvents; ) Object.hasOwnProperty.call(q, "hcEvents") && q.hcEvents[f2] && (z.length && (n2 = true), z.unshift.apply(z, q.hcEvents[f2])), q = Object.getPrototypeOf(q);
        ...
        var n = Array.prototype.find ? function(b2, f2) {
          ...
          var c2, q = b2.length;
          for (c2 = 0; c2 < q; c2++) if (f2(b2[c2], c2)) return b2[c2];
        };
        ...
        f.jQuery && (f.jQuery.fn.highcharts = function() {
          ...
          if (this[0]) return b2[0] ? (new a[C(b2[0]) ? b2.shift() : "Chart"](this[0], b2[0], b2[1]), this) : c[d(this[0], "data-highcharts-chart")];
        });
        n = {
          ...
          arrayMax: function(b2) {
            for (var f2 = b2.length, c2 = b2[0]; f2--; ) b2[f2] > c2 && (c2 = b2[f2]);
            return c2;
          },
          ...
          erase: function(b2, f2) {
            for (var c2 = b2.length; c2--; ) if (b2[c2] === f2) {
              b2.splice(c2, 1);
              break;
            }
          },
          ...
          getNestedProperty: function(b2, c2) {
            for (b2 = b2.split("."); b2.length && e(c2); ) {
              ...
              c2 = c2[q];
              if (!e(c2) || "function" === typeof c2 || "number" === typeof c2.nodeType || c2 === f) return;
            }
            return c2;
          },
          getStyle: I,
          ...
          merge: function() {
            ...
            var n2 = c2.length;
            for (b2 = 0; b2 < n2; b2++) f2 = J(f2, c2[b2]);
            return f2;
          },
          ...
          stableSort: function(b2, c2) {
            ...
            for (n2 = 0; n2 < f2; n2++) b2[n2].safeI = n2;
            b2.sort(function(b3, f3) {
              J = c2(b3, f3);
              return 0 === J ? b3.safeI - f3.safeI : J;
            });
            for (n2 = 0; n2 < f2; n2++) delete b2[n2].safeI;
          },
          syncTimeout: function(b2, c2, f2) {
            if (0 < c2) return setTimeout(b2, c2, f2);
            b2.call(0, f2);
            return -1;
          },
      ...
      K(g, "Core/Color/Color.js", [g["Core/Globals.js"], g["Core/Utilities.js"]], function(a, g2) {
        ...
        g2 = function() {
          function g3(A2) {
            ...
            this.input = A2;
            var t = a.Color;
            if (t && t !== g3) return new t(A2);
            if (!(this instanceof g3)) return new g3(A2);
            this.init(A2);
          }
          ...
          g3.prototype.init = function(a2) {
            var t;
            if ("object" === typeof a2 && "undefined" !== typeof a2.stops) this.stops = a2.stops.map(function(d) {
              return new g3(d[1]);
            });
              ...
              if (!t) for (l = g3.parsers.length; l-- && !t; ) {
                var e = g3.parsers[l];
          ...
          g3.prototype.brighten = function(a2) {
            ...
            else if (A(a2) && 0 !== a2) for (var r = 0; 3 > r; r++) t[r] += C(255 * a2), 0 > t[r] && (t[r] = 0), 255 < t[r] && (t[r] = 255);
            return this;
          };
          ...
          g3.prototype.tweenTo = function(a2, t) {
            ...
            if (!A(r[0]) || !A(l[0])) return a2.input || "none";
            a2 = 1 !== l[3] || 1 !== r[3];
      ...
      K(g, "Core/Time.js", [g["Core/Globals.js"], g["Core/Utilities.js"]], function(a, g2) {
        ...
        g2 = function() {
          ...
          p.prototype.makeTime = function(d2, h2, m2, p2, y, c) {
            ...
            } else w = new this.Date(d2, h2, e(m2, 1), e(p2, 0), e(y, 0), e(c, 0)).getTime();
            return w;
          };
          ...
          p.prototype.dateFormat = function(d2, h2, k2) {
            if (!F(h2) || isNaN(h2)) return a.defaultOptions.lang && a.defaultOptions.lang.invalidDate || "";
            d2 = e(d2, "%Y-%m-%d %H:%M:%S");
            ...
            r(
              p2,
              function(b2, c2) {
                for (; -1 !== d2.indexOf("%" + c2); ) d2 = d2.replace("%" + c2, "function" === typeof b2 ? b2.call(m2, h2) : b2);
              }
            );
          ...
          p.prototype.getTimeTicks = function(d2, k2, p2, m2) {
            ...
            if (F(k2)) {
              ...
              k2 = f.getTime();
              for (f = 1; k2 < p2; ) c.push(k2), k2 = n === h.year ? y.makeTime(z + f * b, 0) : n === h.month ? y.makeTime(z, m2 + f * b) : !u || n !== h.day && n !== h.week ? u && n === h.hour && 1 < b ? y.makeTime(z, m2, q, N + f * b) : k2 + n * b : y.makeTime(z, m2, q + f * b * (n === h.day ? 1 : 7)), f++;
              c.push(k2);
          ...
          p.prototype.getDateFormat = function(d2, e2, k2, p2) {
            ...
            for (f in h) {
              ...
              if (c[f] && m2.substr(c[f]) !== "01-01 00:00:00.000".substr(c[f])) break;
              "week" !== f && (w = f);
            }
      ...
      K(g, "Core/Animation/Fx.js", [
        ...
        return function() {
          ...
          a2.prototype.dSetter = function() {
            ...
            a3 = a3 && a3[1];
            var e = this.now || 0, d = [];
            if (1 !== e && l && a3) if (l.length === a3.length && 1 > e) for (var h = 0; h < a3.length; h++) {
          ...
          a2.prototype.update = function() {
            ...
            else a3.attr ? a3.element && a3.attr(l, e, null, true) : a3.style[l] = e + this.unit;
            d && d.call(a3, e, this);
          };
          a2.prototype.run = function(r, l, e) {
            var d = this, h = d.options, m = function(e2) {
              ...
              for (var d2 = 0; d2 < a2.timers.length; d2++) a2.timers[d2]() || a2.timers.splice(
                d2--,
                1
              );
          ...
          a2.prototype.step = function(a3) {
            ...
            if (d.attr && !d.element) a3 = false;
              ...
              p && h && h.call(d);
              a3 = false;
            } else this.pos = e.easing((l - this.startTime) / m), this.now = this.start + (this.end - this.start) * this.pos, this.update(), a3 = true;
            return a3;
          };
          a2.prototype.initPath = function(a3, l, e) {
            ...
            function h(d2, c) {
              for (; d2.length < L; ) if (c = d2[Math.floor(d2.length / D) - 1].slice(), "C" === c[0] && (c[1] = c[5], c[2] = c[6]), p) {
            ...
            if (!l) return [e, e];
            if (m && k && k.length) {
              for (a3 = 0; a3 < m.length; a3++) if (m[a3] === k[0]) {
                var I = a3;
                break;
      ...
      K(g, "Core/Animation/AnimationUtilities.js", [g["Core/Animation/Fx.js"], g["Core/Utilities.js"]], function(a, g2) {
        ...
        function F(d2, e2) {
          for (var k = a.timers.length; k--; ) a.timers[k].elem !== d2 || e2 && e2 !== a.timers[k].prop || (a.timers[k].stopped = true);
        }
      ...
      K(g, "Core/Renderer/HTML/AST.js", [g["Core/Globals.js"], g["Core/Utilities.js"]], function(a, g2) {
        ...
        t = function() {
            ...
            function h2(d3, m2) {
              ...
              e(d3).forEach(function(d4) {
                ...
                if (c) if ("#text" === c) var n = e2;
                  ...
                  h2(d4.children || [], c);
                  n = c;
                } else H(33, false, void 0, { "Invalid tagName in config": c });
                n && m2.appendChild(n);
                p = n;
              });
              return p;
          ...
          k.prototype.parseMarkup = function(e2) {
            ...
            if (m) e2 = new DOMParser().parseFromString(d ? d.createHTML(e2) : e2, "text/html");
            else {
              var p = C("div");
              p.innerHTML = e2;
              e2 = { body: p };
        ...
        function(a) {
          ...
          (function(a2) {
            function A(a3, r, l) {
              ...
              for (k = a3.length; k--; ) I += a3[k].size;
              if (I > d) {
                F(a3, h);
                for (I = k = 0; I <= d; ) I += a3[k].size, k++;
              ...
              for (a3 = a3.map(function(d2) {
                ...
                for (k = a3.length; k--; ) d = a3[k], h = (Math.min.apply(0, d.targets) + Math.max.apply(0, d.targets)) / 2, d.pos = g2(h - d.size * d.align, 0, r - d.size);
                k = a3.length;
                for (p = false; k--; ) 0 < k && a3[k - 1].pos + a3[k - 1].size > a3[k].pos && (a3[k - 1].size += a3[k].size, a3[k - 1].targets = a3[k - 1].targets.concat(a3[k].targets), a3[k - 1].align = 0.5, a3[k - 1].pos + a3[k - 1].size > r && (a3[k - 1].pos = r - a3[k - 1].size), a3.splice(k, 1), p = true);
              }
              e.push.apply(e, D);
              k = 0;
              a3.some(function(d2) {
                ...
                return (d2.targets || []).some(function() {
                  e[k].pos = d2.pos + h2;
                  if ("undefined" !== typeof l && Math.abs(e[k].pos - e[k].target) > l) return e.slice(0, k + 1).forEach(function(d3) {
      ...
      K(g, "Core/Renderer/SVG/SVGElement.js", [g["Core/Animation/AnimationUtilities.js"], g["Core/Color/Color.js"], g["Core/Globals.js"], g["Core/Utilities.js"]], function(a, g2, x, F) {
        ...
        a = function() {
          ...
          a2.prototype.align = function(c2, f2, d2) {
            ...
            if (c2) {
              if (this.alignOptions = c2, this.alignByTranslate = f2, !d2 || w(d2)) this.alignTo = q2 = d2 || "renderer", I(v, this), v.push(this), d2 = void 0;
            } else c2 = this.alignOptions, f2 = this.alignByTranslate, q2 = this.alignTo;
          ...
          a2.prototype.css = function(b2) {
            ...
            if (q2) {
              ...
              else if ("text" === e2.nodeName.toLowerCase() && b2.width) var v = this.textWidth = u(b2.width);
              this.styles = b2;
          ...
          a2.prototype.dashstyleSetter = function(c2) {
            ...
            if (c2 = c2 && c2.toLowerCase()) {
              ...
              for (c2 = d2.length; c2--; ) d2[c2] = "" + u(d2[c2]) * b(f2, NaN);
          ...
          a2.prototype.destroy = function() {
            ...
            for (f2.styledMode || b2.destroyShadows(); e2 && e2.div && 0 === e2.div.childNodes.length; ) c2 = e2.parentGroup, b2.safeRemoveChild(e2.div), delete e2.div, e2 = c2;
          ...
          a2.prototype.getBBox = function(f2, d2) {
            ...
            if (!m2) {
              if (k2 || q2.forExport) {
                ...
                if (!m2 || 0 > m2.width) m2 = { x: 0, y: 0, width: 0, height: 0 };
              } else m2 = this.htmlGetBBox();
              ...
              if (M && ("" === u2 || 0 < m2.height)) {
                for (; 250 < z2.length; ) delete h2[z2.shift()];
                h2[M] || z2.push(M);
                h2[M] = m2;
              }
            }
          ...
          a2.prototype.strokeWidth = function() {
            ...
            if (b2.indexOf("px") === b2.length - 2) c2 = u(b2);
            else if ("" !== b2) {
          ...
          a2.prototype.updateShadows = function(b2, c2, f2) {
            var d2 = this.shadows;
            if (d2) for (var e2 = d2.length; e2--; ) f2.call(d2[e2], "height" === b2 ? Math.max(c2 - (d2[e2].cutHeight || 0), 0) : "d" === b2 ? this.d : c2, b2, d2[e2]);
          };
          ...
          a2.prototype.zIndexSetter = function(b2, c2) {
            ...
            if (q2) {
              ...
              for (a3 = c2.length - 1; 0 <= a3 && !n2; a3--) {
                ...
                var h2 = !D(q2);
                if (d2 !== v) {
                  if (0 > b2 && h2 && !f2 && !a3) e2.insertBefore(v, c2[a3]), n2 = true;
                  else if (u(q2) <= b2 || h2 && (!D(b2) || 0 <= b2)) e2.insertBefore(v, c2[a3 + 1] || null), n2 = true;
                }
              }
        ...
        var A = this && this.__extends || /* @__PURE__ */ function() {
          var a2 = function(e, d) {
            a2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, e2) {
              ...
              for (var a3 in e2) e2.hasOwnProperty(a3) && (d2[a3] = e2[a3]);
            };
            return a2(e, d);
          };
          return function(e, d) {
        ...
        return function(g3) {
          ...
          e.prototype.updateTextPadding = function() {
            ...
            if (!d.textPath) {
              ...
              if (a2 !== d.x || e2 !== d.y) d.attr("x", a2), d.hasBoxWidthChanged && (this.bBox = d.getBBox(true)), "undefined" !== typeof e2 && d.attr("y", e2);
              d.x = a2;
              d.y = e2;
            }
          };
      ...
      K(g, "Core/Renderer/SVG/TextBuilder.js", [
        ...
        return function() {
          ...
          h.prototype.modifyDOM = function() {
            ...
            for (var h2; h2 = e2.element.firstChild; ) if (/^[\s\u200B]*$/.test(h2.textContent || " ")) e2.element.removeChild(h2);
            else break;
            ...
            if (g3) {
              var l2 = function(h3, c) {
                ...
                if (d2.ellipsis) w && d2.truncate(h3, w, void 0, 0, Math.max(0, g3 - parseInt(d2.fontSize || 12, 10)), function(b2, c2) {
                  return b2.substring(0, c2) + "…";
                });
                else if (n) {
                  w = [];
                  for (n = []; c.firstChild && c.firstChild !== h3; ) n.push(c.firstChild), c.removeChild(c.firstChild);
                  for (; f.length; ) f.length && !d2.noWrap && 0 < u && (w.push(h3.textContent || ""), h3.textContent = f.join(" ").replace(/- /g, "-")), d2.truncate(h3, void 0, f, 0 === u ? z || 0 : 0, g3, function(b2, c2) {
          ...
          h.prototype.modifyTree = function(d2) {
            var e2 = this, a2 = function(h2, k) {
              ...
              if ("b" === c || "strong" === c) w ? m["class"] = "highcharts-strong" : g3.fontWeight = "bold";
              else if ("i" === c || "em" === c) w ? m["class"] = "highcharts-emphasized" : g3.fontStyle = "italic";
          ...
          h.prototype.truncate = function(d2, e2, a2, h2, g3, l2) {
            var k = this.svgElement, m = k.renderer, c = k.rotation, w = [], f = a2 ? 1 : 0, n = (e2 || a2 || "").length, b = n, u, z = function(b2, c2) {
              ...
              if (f2 && "undefined" === typeof w[c2]) if (f2.getSubStringLength) try {
                w[c2] = h2 + f2.getSubStringLength(0, a2 ? c2 + 1 : c2);
              } catch (Q) {
                "";
              }
              else m.getSpanWidth && (d2.textContent = l2(e2 || a2, b2), w[c2] = h2 + m.getSpanWidth(k, d2));
              return w[c2];
            };
            k.rotation = 0;
            var q = z(d2.textContent.length);
            if (h2 + q > g3) {
              for (; f <= n; ) b = Math.ceil((f + n) / 2), a2 && (u = l2(a2, b)), q = z(b, u && u.length - 1), f === n ? f = n + 1 : q > g3 ? n = b - 1 : f = b;
      ...
      K(g, "Core/Renderer/SVG/SVGRenderer.js", [
        ...
        x = function() {
          ...
          v.prototype.symbol = function(e2, v2, a2, n2, G, q2) {
            ...
            if (g3) {
              ...
              f(U.imgwidth) && f(U.imgheight) ? N2(U) : (U.attr({ width: 0, height: 0 }), c("img", { onload: function() {
                ...
                u2.imgCount--;
                if (!u2.imgCount && b2 && !b2.hasLoaded) b2.onload();
              }, src: P }), this.imgCount++);
            }
            return p2;
          };
          ...
          v.prototype.text = function(b2, c2, d2, e2) {
            var v2 = {};
            if (e2 && (this.allowHTML || !this.forExport)) return this.html(b2, c2, d2);
            v2.x = Math.round(c2 || 0);
            d2 && (v2.y = Math.round(d2));
            f(b2) && (v2.text = b2);
            b2 = this.createElement("text").attr(v2);
            if (!e2 || this.forExport && !this.allowHTML) b2.xSetter = function(b3, c3, f2) {
              for (var d3 = f2.getElementsByTagName("tspan"), e3 = f2.getAttribute(c3), v3 = 0, a2; v3 < d3.length; v3++) a2 = d3[v3], a2.getAttribute(c3) === e3 && a2.setAttribute(c3, b3);
          ...
          v.prototype.pathToSegments = function(b2) {
            for (var c2 = [], f2 = [], d2 = { A: 8, C: 7, H: 2, L: 3, M: 3, Q: 5, S: 5, T: 3, V: 2 }, e2 = 0; e2 < b2.length; e2++) N(f2[0]) && z(b2[e2]) && f2.length === d2[f2[0].toUpperCase()] && b2.splice(e2, 0, f2[0].replace("M", "L").replace("m", "l")), "string" === typeof b2[e2] && (f2.length && c2.push(f2.slice(0)), f2.length = 0), f2.push(b2[e2]);
            c2.push(f2.slice(0));
            return c2;
          };
        ...
        var A = this && this.__extends || /* @__PURE__ */ function() {
          var d2 = function(e2, a2) {
            d2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d3, e3) {
              ...
              for (var a3 in e3) e3.hasOwnProperty(a3) && (d3[a3] = e3[a3]);
            };
            return d2(e2, a2);
          };
            ...
            if (this.added) {
              ...
              if ("SPAN" === e2.tagName) {
                ...
                if (b !== this.oldTextWidth) {
                  ...
                  else r(e2, { width: "", whiteSpace: f || "nowrap" }), q = e2.offsetWidth;
          ...
          e.prototype.html = function(d, e2, m) {
            ...
            I && (h.add = function(d2) {
              ...
              if (this.parentGroup = d2) {
                var a2 = d2.div;
                if (!a2) {
                  for (; d2; ) c.push(d2), d2 = d2.parentGroup;
        ...
        g2 = function() {
          ...
          g3.prototype.addLabel = function() {
            ...
            if (h2.dateTime) if (n) {
              ...
              var O = J.main;
            } else e(L) && (O = h2.dateTime.getXDateFormat(L, g4.dateTimeLabelFormats || {}));
            d2.isFirst = b;
            d2.isLast = u;
            ...
            d2.shortenLabel = Y ? function() {
              for (N = 0; N < Y.length; N++) if (r(Q, { dateTimeLabelFormat: Y[N] }), q.attr({ text: t2.call(Q, Q) }), q.getBBox().width < h2.getSlotWidth(d2) - 2 * f.padding) return;
              q.attr({ text: "" });
            } : void 0;
          ...
          g3.prototype.createLabel = function(e2, a2, h2) {
            ...
            if (e2 = H(a2) && h2.enabled ? k.renderer.text(a2, e2.x, e2.y, h2.useHTML).add(g4.labelGroup) : null) k.styledMode || e2.css(d(h2.style)), e2.textPxLength = e2.getBBox().width;
            return e2;
          };
          ...
          g3.prototype.handleOverflow = function(d2) {
            ...
            if (f || "justify" !== a2.overflow) 0 > f && h2 - n * b < c ? l2 = Math.round(h2 / Math.cos(f * A) - c) : 0 < f && h2 + n * b > k && (l2 = Math.round((g4 - h2) / Math.cos(f * A)));
            else if (g4 = h2 + (1 - n) * b, h2 - n * b < c ? q = d2.x + q * (1 - n) - c : g4 > k && (q = k - d2.x + q * n, p = -1), q = Math.min(u, q), q < u && "center" === e2.labelAlign && (d2.x += p * (u - q - n * (u - Math.min(b, q)))), b > q || e2.autoRotation && (w.styles || {}).width) l2 = q;
          ...
          g3.prototype.renderGridLine = function(d2, e2, a2) {
            ...
            if (b && (a2 = h2.getPlotLinePath({ value: c + f, lineWidth: b.strokeWidth() * a2, force: "pass", old: d2, acrossPanes: false }))) b[d2 || this.isNew ? "attr" : "animate"]({ d: a2, opacity: e2 });
          };
      ...
      K(g, "Core/Axis/Axis.js", [
        ...
        a = function() {
          ...
          a2.prototype.defaultLabelFormatter = function(b2) {
            ...
            if (c2.categories) var u2 = "".concat(this.value);
            else if (e2) u2 = a3.dateFormat(e2, d2);
            else if (q2 && 1e3 <= h2) for (; q2-- && "undefined" === typeof u2; ) c2 = Math.pow(v, q2 + 1), h2 >= c2 && 0 === 10 * d2 % c2 && null !== n2[q2] && 0 !== d2 && (u2 = b2(d2 / c2, -1) + n2[q2]);
            ...
            c(this, "getSeriesExtremes", null, function() {
              ...
              b2.series.forEach(function(c2) {
                if (c2.visible || !d2.options.chart.ignoreHiddenSeries) {
                  ...
                  } else if (c2 = c2.applyExtremes(), f(c2.dataMin) && (n2 = c2.dataMin, b2.dataMin = Math.min(q(b2.dataMin, n2), n2)), f(c2.dataMax) && (h2 = c2.dataMax, b2.dataMax = Math.max(q(b2.dataMax, h2), h2)), D(v) && (b2.threshold = v), !e2.softThreshold || b2.positiveValuesOnly) b2.softThreshold = false;
                }
              });
            });
          ...
          a2.prototype.getMinorTickPositions = function() {
            ...
            if (e2 && e2 / f2 < this.len / 3) {
              ...
              if (h2) this.paddedTicks.forEach(function(b3, c3, d3) {
                c3 && n2.push.apply(
                  n2,
                  h2.getLogTickPositions(f2, d3[c3 - 1], d3[c3], true)
                );
              });
              else if (this.dateTime && "auto" === this.getMinorTickInterval()) n2 = n2.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(f2), a3, d2, b2.startOfWeek));
              else for (b2 = a3 + (c2[0] - a3) % f2; b2 <= d2 && b2 !== n2[0]; b2 += f2) n2.push(b2);
            }
          ...
          a2.prototype.adjustForMinRange = function() {
            ...
            this.isXAxis && "undefined" === typeof this.minRange && !c2 && (D(b2.min) || D(b2.max) || D(b2.floor) || D(b2.ceiling) ? this.minRange = null : (this.series.forEach(function(b3) {
              ...
              if (1 < u2.length) {
                for (e2 = g3; 0 < e2; e2--) if (n2 = u2[e2] - u2[e2 - 1], !a3 || n2 < a3) a3 = n2;
              }
          ...
          a2.prototype.setAxisTranslation = function() {
            ...
            if (e2 || a3 || h2) {
              ...
              d2 ? (u2 = d2.minPointOffset, g3 = d2.pointRangePadding) : b2.series.forEach(function(c2) {
                ...
                h2 = Math.max(h2, f3);
                if (!b2.single || a3) c2 = c2.is("xrange") ? !e2 : e2, u2 = Math.max(u2, c2 && n(d3) ? 0 : f3 / 2), g3 = Math.max(g3, c2 && "on" === d3 ? 0 : f3);
              });
          ...
          a2.prototype.setTickPositions = function() {
            ...
            if (d2) h2 = d2.slice();
              ...
              if (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))) if (this.dateTime) h2 = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, b2.units), this.min, this.max, b2.startOfWeek, this.ordinal && this.ordinal.positions, this.closestPointRange, true);
              else if (this.logarithmic) h2 = this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max);
              else for (e2 = b2 = this.tickInterval; e2 <= 2 * b2; ) if (h2 = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && h2.length > this.tickAmount) this.tickInterval = T(this, e2 *= 1.1);
              else break;
              else h2 = [this.min, this.max], A(19, false, this.chart);
          ...
          a2.prototype.trimTicks = function(b2, f2, d2) {
            ...
            c(this, "trimTicks");
            if (!this.isLinked) {
              if (f2 && -Infinity !== a3) this.min = a3;
              else for (; this.min - h2 > b2[0]; ) b2.shift();
              if (d2) this.max = e2;
              else for (; this.max + h2 < b2[b2.length - 1]; ) b2.pop();
          ...
          a2.prototype.getThresholdAlignment = function(b2) {
            ...
            if (f(this.threshold)) return b2 = k((this.threshold - (this.dataMin || 0)) / ((this.dataMax || 0) - (this.dataMin || 0)), 0, 1), this.options.reversed && (b2 = 1 - b2), b2;
          };
            ...
            if (b2.hasData() && f(a3) && f(d2)) {
              ...
              if (f(w2) && f(b2.threshold)) {
                for (; h2[w2] !== k2 || h2.length !== n2 || h2[0] > a3 || h2[h2.length - 1] < d2; ) {
                  h2.length = 0;
                  for (h2.push(b2.threshold); h2.length < n2; ) void 0 === h2[w2] || h2[w2] > b2.threshold ? h2.unshift(p(h2[0] - z2)) : h2.push(p(h2[h2.length - 1] + z2));
                  if (z2 > 8 * b2.tickInterval) break;
                  z2 *= 2;
                }
                u2();
              } else if (g3 < n2) {
                for (; h2.length < n2; ) h2.length % 2 || a3 === k2 ? h2.push(p(h2[h2.length - 1] + z2)) : h2.unshift(p(h2[0] - z2));
                u2();
              }
              if (D(c2)) {
                for (z2 = k2 = h2.length; z2--; ) (3 === c2 && 1 === z2 % 2 || 2 >= c2 && 0 < z2 && z2 < k2 - 1) && h2.splice(z2, 1);
          ...
          a2.prototype.zoom = function(b2, f2) {
            ...
            c(this, "zoom", b2, function(b3) {
              ...
              if (c2 !== d2.min || f3 !== d2.max) d2.allowZoomOutside || (D(a3) && (c2 < n2 && (c2 = n2), c2 > u2 && (c2 = u2)), D(e2) && (f3 < n2 && (f3 = n2), f3 > u2 && (f3 = u2))), d2.displayBtn = "undefined" !== typeof c2 || "undefined" !== typeof f3, d2.setExtremes(
                c2,
                f3,
                false,
                void 0,
          ...
          a2.prototype.unsquish = function() {
            ...
            if (c2) {
              if (!b2.staggerLines) if (f(h2)) var w2 = [h2];
              else e2 < b2.autoRotationLimit && (w2 = b2.autoRotation);
              if (w2) for (var m2 = c2 = void 0, l2 = 0, J2 = w2; l2 < J2.length; l2++) {
                var N2 = J2[l2];
          ...
          a2.prototype.getSlotWidth = function(b2) {
            ...
            if (b2 && f(b2.slotWidth)) return b2.slotWidth;
            if (d2 && 2 > a3.step) return a3.rotation ? 0 : (this.staggerLines || 1) * this.len / e2;
            if (!d2) {
              b2 = a3.style.width;
              if (void 0 !== b2) return parseInt(String(b2), 10);
              if (h2) return h2 - c2.spacing[3];
            }
          ...
          a2.prototype.renderUnsquish = function() {
            ...
            if (this.autoRotation) w2 > q2 && w2 > z2.h ? g3.rotation = this.labelRotation : this.labelRotation = 0;
            else if (u2) {
              var m2 = q2;
              if (!k2) {
                var l2 = "clip";
                for (q2 = f2.length; !h2 && q2--; ) {
                  var p2 = f2[q2];
                  if (p2 = d2[p2].label) p2.styles && "ellipsis" === p2.styles.textOverflow ? p2.css({ textOverflow: "clip" }) : p2.textPxLength > u2 && p2.css({ width: u2 + "px" }), p2.getBBox().height > this.len / f2.length - (z2.h - z2.f) && (p2.specificTextOverflow = "ellipsis");
                }
              }
            }
            g3.rotation && (m2 = w2 > 0.5 * b2.chartHeight ? 0.33 * b2.chartHeight : w2, k2 || (l2 = "ellipsis"));
            if (this.labelAlign = a3.align || this.autoLabelAlign(this.labelRotation)) g3.align = this.labelAlign;
            f2.forEach(function(b3) {
          ...
          a2.prototype.renderTick = function(b2, c2, f2) {
            var d2 = this.ticks;
            if (!this.isLinked || b2 >= this.min && b2 <= this.max || this.grid && this.grid.isColumn) d2[b2] || (d2[b2] = new H(this, b2)), f2 && d2[b2].isNew && d2[b2].render(c2, true, -1), d2[b2].render(c2);
          };
          a2.prototype.render = function() {
            ...
            [q2, g3, k2].forEach(function(b3) {
              ...
              Q(function() {
                for (var f3 = c2.length; f3--; ) b3[c2[f3]] && !b3[c2[f3]].isActive && (b3[c2[f3]].destroy(), delete b3[c2[f3]]);
          ...
          a2.prototype.destroy = function(b2) {
            ...
            if (d2) for (b2 = d2.length; b2--; ) d2[b2].destroy();
            "axisLine axisTitle axisGroup gridGroup labelGroup cross scrollbar".split(" ").forEach(function(b3) {
              f2[b3] && (f2[b3] = f2[b3].destroy());
            });
            for (var e2 in f2.plotLinesAndBandsGroups) f2.plotLinesAndBandsGroups[e2] = f2.plotLinesAndBandsGroups[e2].destroy();
            z(f2, function(b3, c2) {
          ...
          a2.prototype.remove = function(b2) {
            for (var c2 = this.chart, f2 = this.coll, d2 = this.series, a3 = d2.length; a3--; ) d2[a3] && d2[a3].remove(false);
            E(c2.axes, this);
            E(c2[f2], this);
        ...
        (function(a2) {
          ...
          var l = function() {
            ...
            a3.prototype.getLogTickPositions = function(d, a4, e, g3) {
              ...
              if (0.5 <= d) d = Math.round(d), l2 = h.getLinearTickPositions(d, a4, e);
              else if (0.08 <= d) {
              ...
              } else a4 = this.lin2log(a4), e = this.lin2log(e), d = g3 ? h.getMinorTickInterval() : m.tickInterval, d = F("auto" === d ? null : d, this.minorAutoInterval, m.tickPixelInterval / (g3 ? 5 : 1) * (e - a4) / ((g3 ? k / h.tickPositions.length : k) || 1)), d = x(d), l2 = h.getLinearTickPositions(d, a4, e).map(this.log2lin), g3 || (this.minorAutoInterval = d / 5);
              g3 || (h.tickInterval = d);
              return l2;
            };
        ...
        (function(a2) {
          ...
          var r = function() {
            ...
            a3.prototype.removePlotBandOrLine = function(a4) {
              ...
              if (d) {
                for (var k = d.length; k--; ) d[k].id === a4 && d[k].destroy();
                [e.plotLines || [], m.plotLines || [], e.plotBands || [], m.plotBands || []].forEach(function(d2) {
                  for (k = d2.length; k--; ) (d2[k] || {}).id === a4 && g2(d2, d2[k]);
                });
              }
            };
      ...
      K(g, "Core/Axis/PlotLineOrBand/PlotLineOrBand.js", [g["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"], g["Core/Utilities.js"]], function(a, g2) {
        ...
        g2 = function() {
          ...
          d.prototype.render = function() {
            ...
            if (q) q = d2.getPlotLinePath({ value: u, lineWidth: z.strokeWidth(), acrossPanes: D.acrossPanes });
            else if (N) q = d2.getPlotBandPath(b, n, D);
            else return;
      ...
      K(g, "Core/Tooltip.js", [g["Core/FormatUtilities.js"], g["Core/Globals.js"], g["Core/Renderer/RendererUtilities.js"], g["Core/Renderer/RendererRegistry.js"], g["Core/Utilities.js"]], function(a, g2, x, F, C) {
        ...
        a = function() {
          ...
          a2.prototype.getAnchor = function(c, a3) {
            ...
            if (this.followPointer && a3) "undefined" === typeof a3.chartX && (a3 = d2.normalize(a3)), c = [a3.chartX - f, a3.chartY - e2];
            else if (c[0].tooltipPos) c = c[0].tooltipPos;
            else {
              var h2 = 0, g3 = 0;
              c.forEach(function(b2) {
                if (b2 = b2.pos(true)) h2 += b2[0], g3 += b2[1];
              });
              h2 /= c.length;
              g3 /= c.length;
          ...
          a2.prototype.getPosition = function(c, a3, f) {
            ...
            var r2 = !this.followPointer && I(f.ttBelow, !d2.inverted === l2), t2 = function(c2, f2, a4, d3, n, u, q) {
              ...
              n = n + z - k3;
              if (r2 && G2) e2[c2] = n;
              else if (!r2 && w2) e2[c2] = l3;
              else if (w2) e2[c2] = Math.min(q - d3, 0 > l3 - h2 ? l3 : l3 - h2);
              else if (G2) e2[c2] = Math.max(u, n + h2 + a4 > f2 ? n : n + h2);
              else return false;
          ...
          a2.prototype.refresh = function(c, a3) {
            ...
            if (d2.enabled && g3.series) {
              ...
              if (false === k2) this.hide();
              else {
                if (this.split && this.allowShared) this.renderSplit(k2, e2);
                else {
                  var v = y, t2 = r2;
          ...
          a2.prototype.updatePosition = function(c) {
            ...
            if (this.outside) {
              ...
              if (1 !== k2 || 1 !== h2) l(this.container, { transform: "scale(".concat(k2, ", ").concat(h2, ")") }), p2 *= k2, c *= h2;
              p2 += b - m2.x;
              c += g3 - m2.y;
            }
      ...
      K(g, "Core/Series/Point.js", [g["Core/Renderer/HTML/AST.js"], g["Core/Animation/AnimationUtilities.js"], g["Core/Defaults.js"], g["Core/FormatUtilities.js"], g["Core/Utilities.js"]], function(a, g2, x, F, C) {
        ...
        g2 = function() {
          ...
          g3.prototype.destroy = function() {
            function b() {
              if (a2.graphic || a2.graphics || a2.dataLabel || a2.dataLabels) w(a2), a2.destroyElements();
              for (n in a2) a2[n] = null;
            }
            ...
            if (a2 === d2.hoverPoint) a2.onMouseOut();
          ...
          g3.prototype.getZone = function() {
            ...
            b = b.zoneAxis || "y";
            var a2, f2 = 0;
            for (a2 = c2[f2]; this[b] >= a2.value; ) a2 = c2[++f2];
          ...
          g3.prototype.optionsToObject = function(b) {
            ...
            if (D(b) || null === b) e2[f2[0]] = b;
            else if (k(b)) for (!a2 && b.length > d2 && (c2 = typeof b[0], "string" === c2 ? e2.name = b[0] : "number" === c2 && (e2.x = b[0]), h2++); n < d2; ) a2 && "undefined" === typeof b[h2] || (0 < f2[n].indexOf(".") ? g3.prototype.setNestedProperty(
              e2,
              b[h2],
              f2[n]
            ) : e2[f2[n]] = b[h2]), h2++, n++;
            else "object" === typeof b && (e2 = b, b.dataLabels && (c2._hasPointLabels = true), b.marker && (c2._hasPointMarkers = true));
            return e2;
          };
          g3.prototype.pos = function(b, c2) {
            ...
            f2 = f2.yAxis;
            var h2 = 0, g4 = 0;
            if (D(a2) && D(c2)) return b && (h2 = e2 ? e2.pos : d2.plotLeft, g4 = f2 ? f2.pos : d2.plotTop), d2.inverted && e2 && f2 ? [f2.len - c2 + g4, e2.len - a2 + h2] : [a2 + h2, c2 + g4];
          };
          g3.prototype.resolveColor = function() {
            ...
            } else c2 || (f2 = b.color), c2 = b.colorIndex;
          ...
          g3.prototype.tooltipFormatter = function(b) {
            ...
            (c2.pointArrayMap || ["y"]).forEach(function(c3) {
              c3 = "{point." + c3;
              if (d2 || e2) b = b.replace(RegExp(c3 + "}", "g"), d2 + c3 + "}" + e2);
            ...
            if (!(b === this.state && !c2 || this.selected && "select" !== b || false === g4.enabled || b && (m2 || u && false === k2.enabled) || b && w2.states && w2.states[b] && false === w2.states[b].enabled)) {
              ...
              if (this.graphic && !this.hasMockGraphic) {
                ...
                if (b && k2) {
                  ...
                  if (t2) if (E2) E2[c2 ? "animate" : "attr"]({ x: t2.x, y: t2.y });
                  else n && (f2.stateMarkerGraphic = E2 = l2.renderer.symbol(n, t2.x, t2.y, t2.width, t2.height).add(f2.markerGroup), E2.currentSymbol = n);
        ...
        a = function() {
          ...
          a2.prototype.drop = function(c) {
            ...
            if (this.selectionMarker) {
              ...
              if (this.hasDragged || h2) f.axes.forEach(function(b2) {
          ...
          a2.prototype.getPointFromEvent = function(c) {
            c = c.target;
            for (var a3; c && !a3; ) a3 = c.point, c = c.parentNode;
            return a3;
          };
          a2.prototype.onTrackerMouseOut = function(c) {
            ...
            if (!(!a3 || !c || a3.stickyTracking || this.inClass(c, "highcharts-tooltip") || this.inClass(c, "highcharts-series-" + a3.index) && this.inClass(c, "highcharts-tracker"))) a3.onMouseOut();
          };
          a2.prototype.inClass = function(c, a3) {
            for (var f; c; ) {
              if (f = r(c, "class")) {
                if (-1 !== f.indexOf(a3)) return true;
                if (-1 !== f.indexOf("highcharts-container")) return false;
              }
              c = c.parentElement;
            }
          };
          ...
          a2.prototype.onContainerMouseDown = function(a3) {
            ...
            if (g2.isFirefox && 0 !== a3.button) this.onContainerMouseMove(a3);
            if ("undefined" === typeof a3.button || c) this.zoomOption(a3), c && a3.preventDefault && a3.preventDefault(), this.dragStart(a3);
          };
          ...
          a2.prototype.pinchTranslateDirection = function(a3, d2, f, e2, b, h2, g3, k2) {
            ...
            if (f < p2.min) {
              f = p2.min;
              var E2 = true;
            } else f + G > p2.max && (f = p2.max - G, E2 = true);
          ...
          a2.prototype.reset = function(a3, d2) {
            ...
            if (a3) g3 && k2 && L(k2).length && (g3.refresh(k2), g3.shared && h2 ? h2.forEach(function(b2) {
          ...
          a2.prototype.runPointActions = function(c, d2, f) {
            ...
            if (k2 && (f || k2 !== e2.hoverPoint || b && b.isHidden)) {
              ...
              if (e2.hoverSeries !== q) q.onMouseOver();
            ...
            } else d2 && b && !b.isHidden && (f = b.getAnchor([{}], c), e2.isInsidePlot(f[0], f[1], { visiblePlotOnly: true }) && b.updatePosition({ plotX: f[0], plotY: f[1] }));
          ...
          a2.prototype.setDOMEvents = function() {
            ...
            for (var e2 = this.chart.renderTo.parentElement; e2 && "BODY" !== e2.tagName; ) this.eventsToUnbind.push(t(e2, "scroll", function() {
          ...
          a2.prototype.setHoverChartIndex = function() {
            ...
            if (d2 && d2 !== c) d2.pointer.onContainerMouseLeave({ relatedTarget: c.container });
        ...
        var B = this && this.__extends || /* @__PURE__ */ function() {
          var a2 = function(d2, e2) {
            a2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(a3, c) {
              ...
              for (var d3 in c) c.hasOwnProperty(d3) && (a3[d3] = c[d3]);
            };
            return a2(d2, e2);
          };
      ...
      K(g, "Core/Legend/Legend.js", [g["Core/Animation/AnimationUtilities.js"], g["Core/FormatUtilities.js"], g["Core/Globals.js"], g["Core/Series/Point.js"], g["Core/Renderer/RendererUtilities.js"], g["Core/Utilities.js"]], function(a, g2, x, F, C, B) {
        ...
        a = function() {
          ...
          a2.prototype.colorizeItem = function(b, a3) {
            ...
            c2 = c2.symbol;
            if (d2) d2[a3 ? "removeClass" : "addClass"]("highcharts-legend-item-hidden");
          ...
          a2.prototype.destroy = function() {
            for (var b = 0, a3 = this.getAllItems(); b < a3.length; b++) this.destroyItem(a3[b]);
            b = 0;
          ...
          a2.prototype.render = function() {
            ...
            if (0 < e2 && 0 < n) g3[g3.placed ? "animate" : "attr"](g3.crisp.call({}, { x: 0, y: 0, width: e2, height: n }, g3.strokeWidth()));
            h2[k2 ? "show" : "hide"]();
          ...
          a2.prototype.handleOverflow = function(b) {
            ...
            b && 0 < e2 && b > e2 && false !== n.enabled ? (this.clipHeight = P = Math.max(e2 - 20 - this.titleHeight - g3, 0), this.currentPage = y(this.currentPage, 1), this.fullHeight = b, r2.forEach(function(b2, a4) {
              ...
              if (!d3 || b2 - p2[d3 - 1] > P && (M || b2) !== p2[d3 - 1]) p2.push(M || b2), d3++;
              t2.pageIx = d3 - 1;
          ...
          a2.prototype.setItemEvents = function(b, a3, c2) {
            ...
            for (c2 = c2 ? [a3, f2.symbol] : [f2.group]; m2 < c2.length; m2++) if (f2 = c2[m2]) f2.on("mouseover", function() {
      ...
      K(g, "Core/Chart/Chart.js", [
        ...
        a = function() {
          ...
          a2.prototype.redraw = function(b2) {
            ...
            if (G2) for (b2 = c2.length; b2--; ) q2 = c2[b2], q2.options.stacking && (q2.isDirty = true);
            c2.forEach(function(b3) {
          ...
          a2.prototype.get = function(b2) {
            ...
            for (var c2 = this.series, d2 = ca(this.axes, a3) || ca(this.series, a3), f2 = 0; !d2 && f2 < c2.length; f2++) d2 = ca(c2[f2].points || [], a3);
            return d2;
          };
          ...
          a2.prototype.temporaryDisplay = function(b2) {
            ...
            if (b2) for (; a3 && a3.style; ) a3.hcOrigStyle && (Q(a3, a3.hcOrigStyle), delete a3.hcOrigStyle), a3.hcOrigDetached && (f.body.removeChild(a3), a3.hcOrigDetached = false), a3 = a3.parentNode;
            else for (; a3 && a3.style; ) {
              f.body.contains(a3) || a3.parentNode || (a3.hcOrigDetached = true, f.body.appendChild(a3));
              if ("none" === G(a3, "display", false) || a3.hcOricDetached) a3.hcOrigStyle = { display: a3.style.display, height: a3.style.height, overflow: a3.style.overflow }, b2 = { display: "block", overflow: "hidden" }, a3 !== this.renderTo && (b2.height = 0), Q(a3, b2), a3.offsetWidth || a3.style.setProperty("display", "block", "important");
              a3 = a3.parentNode;
              if (a3 === f.body) break;
            }
          };
          ...
          a2.prototype.getContainer = function() {
            ...
            if (this.styledMode) for (var q2 in a3.defs) this.renderer.definition(a3.defs[q2]);
          ...
          a2.prototype.reflow = function(b2) {
            ...
            if (!e2 && !a3.isPrinting && h2 && c2 && (d2 === u || d2 === f)) {
              if (h2 !== a3.containerWidth || c2 !== a3.containerHeight) m.clearTimeout(a3.reflowTimeout), a3.reflowTimeout = ia(function() {
          ...
          a2.prototype.drawChartBox = function() {
            ...
            if (f2) var y2 = r2 = M2.strokeWidth();
            else {
              y2 = b2.borderWidth || 0;
              r2 = y2 + (b2.shadow ? 8 : 0);
              h2 = { fill: h2 || "none" };
              if (y2 || M2["stroke-width"]) h2.stroke = b2.borderColor, h2["stroke-width"] = y2;
          ...
          a2.prototype.propFromSeries = function() {
            ...
            ["inverted", "angular", "polar"].forEach(function(h2) {
              ...
              for (d2 = c2 && c2.length; !e2 && d2--; ) (f2 = z[c2[d2].type]) && f2.prototype[h2] && (e2 = true);
              b2[h2] = e2;
            });
          };
          ...
          a2.prototype.render = function() {
            ...
            d2 = this.plotWidth;
            b2.some(function(b3) {
              if (b3.horiz && b3.visible && b3.options.labels.enabled && b3.series.length) return e2 = 21, true;
            });
            ...
            if (g3 || k2) b2.forEach(function(b3) {
          ...
          a2.prototype.destroy = function() {
            ...
            ha(b2);
            for (e2 = a3.length; e2--; ) a3[e2] = a3[e2].destroy();
            this.scroller && this.scroller.destroy && this.scroller.destroy();
            for (e2 = c2.length; e2--; ) c2[e2] = c2[e2].destroy();
          ...
          a2.prototype.update = function(b2, a3, d2, f2) {
            ...
            Z(b2, function(a4, c2) {
              if (e2[c2] && "function" === typeof e2[c2].update) e2[c2].update(a4, false);
              else if ("function" === typeof e2[g3[c2]]) e2[g3[c2]](a4);
              else "colors" !== c2 && -1 === e2.collectionsWithUpdate.indexOf(c2) && V(true, e2.options[c2], b2[c2]);
          ...
          a2.prototype.zoom = function(b2) {
            ...
            !b2 || b2.resetSelection ? (a3.axes.forEach(function(b3) {
              ...
              var e3 = b3.axis;
              if (c2[e3.isXAxis ? "zoomX" : "zoomY"] && T(c2.mouseDownX) && T(c2.mouseDownY) && a3.isInsidePlot(c2.mouseDownX - a3.plotLeft, c2.mouseDownY - a3.plotTop, { axis: e3 }) || !T(a3.inverted ? c2.mouseDownX : c2.mouseDownY)) f2 = e3.zoom(b3.min, b3.max), e3.displayBtn && (d2 = true);
            });
      ...
      K(g, "Core/Series/Series.js", [
        ...
        a = function() {
          ...
          a2.prototype.init = function(b2, a3) {
            ...
            m(this, a3);
            var f2 = a3.events;
            if (f2 && f2.click || a3.point && a3.point.events && a3.point.events.click || a3.allowPointSelect) b2.runTrackerClick = true;
            c2.getColor();
            c2.getSymbol();
          ...
          a2.prototype.insert = function(b2) {
            ...
            if (O(a3)) {
              for (c2 = b2.length; c2--; ) if (a3 >= v(b2[c2].options.index, b2[c2]._i)) {
            ...
            q(this, "bindAxes", null, function() {
              (a3.axisTypes || []).forEach(function(e2) {
                ...
                d2[e2].forEach(function(b2) {
                  f2 = b2.options;
                  if (c2[e2] === h2 && !f2.isInternal || "undefined" !== typeof c2[e2] && c2[e2] === f2.id || "undefined" === typeof c2[e2] && 0 === f2.index) a3.insert(b2.series), a3[e2] = b2, b2.isDirty = true;
                  f2.isInternal || h2++;
                });
          ...
          a2.prototype.findPointIndex = function(b2, a3) {
            ...
            if (c2) e2 = this.chart.get(c2), e2 instanceof B && (h2 = e2);
          ...
          a2.prototype.updateData = function(b2, a3) {
            ...
            b2.forEach(function(b3, a4) {
              ...
              if (m3.id || O(l3)) {
                if (m3 = this.findPointIndex(m3, q2), -1 === m3 || "undefined" === typeof m3 ? h2.push(b3) : e2[m3] && b3 !== c2.data[m3] ? (e2[m3].update(b3, false, null, false), e2[m3].touched = true, g3 && (q2 = m3 + 1)) : e2[m3] && (e2[m3].touched = true), !k2 || a4 !== m3 || d2 && d2.enabled || this.hasDerivedData) n2 = true;
              } else h2.push(b3);
            }, this);
            if (n2) for (b2 = e2.length; b2--; ) (m2 = e2[b2]) && !m2.touched && m2.remove && m2.remove(false, a3);
            else !k2 || d2 && d2.enabled ? l2 = false : (b2.forEach(function(b3, a4) {
          ...
          a2.prototype.setData = function(a3, c2, d2, f2) {
            ...
            if (!w2) {
              ...
              if (q2 && M > q2) if (y2 = e2.getFirstValidPoint(a3), O(y2)) for (d2 = 0; d2 < M; d2++) u2[d2] = this.autoIncrement(), p2[d2] = a3[d2];
              else if (J(y2)) if (G) if (y2.length === G) for (d2 = 0; d2 < M; d2++) u2[d2] = this.autoIncrement(), p2[d2] = a3[d2];
              else for (d2 = 0; d2 < M; d2++) f2 = a3[d2], u2[d2] = f2[0], p2[d2] = f2.slice(1, G + 1);
              else if (v2 && (r2 = v2.indexOf("x"), z2 = v2.indexOf("y"), r2 = 0 <= r2 ? r2 : 0, z2 = 0 <= z2 ? z2 : 1), 1 === y2.length && (z2 = 0), r2 === z2) for (d2 = 0; d2 < M; d2++) u2[d2] = this.autoIncrement(), p2[d2] = a3[d2][z2];
              else for (d2 = 0; d2 < M; d2++) f2 = a3[d2], u2[d2] = f2[r2], p2[d2] = f2[z2];
              else b(12, false, n2);
              else for (d2 = 0; d2 < M; d2++) "undefined" !== typeof a3[d2] && (f2 = { series: e2 }, e2.pointClass.prototype.applyOptions.apply(f2, [a3[d2]]), e2.updateParallelArrays(f2, d2));
              p2 && Q(p2[0]) && b(14, true, n2);
              e2.data = [];
              e2.options.data = e2.userOptions.data = a3;
              for (d2 = g3; d2--; ) h2[d2] && h2[d2].destroy && h2[d2].destroy();
          ...
          a2.prototype.getProcessedData = function(a3) {
            ...
            for (e2 = k2.length || 1; --e2; ) if (c2 = d2 ? a3(k2[e2]) - a3(k2[e2 - 1]) : k2[e2] - k2[e2 - 1], 0 < c2 && ("undefined" === typeof v2 || c2 < v2)) var v2 = c2;
            else 0 > c2 && m2 && !l2 && (b(15, false, this.chart), m2 = false);
            return { xData: k2, yData: n2, cropped: G, cropStart: g3, closestPointRange: v2 };
          };
          a2.prototype.processData = function(b2) {
            var a3 = this.xAxis;
            if (this.isCartesian && !this.isDirty && !a3.isDirty && !this.yAxis.isDirty && !b2) return false;
          ...
          a2.prototype.cropData = function(b2, a3, c2, d2, e2) {
            ...
            for (h2 = 0; h2 < f2; h2++) if (b2[h2] >= c2) {
              g3 = Math.max(0, h2 - e2);
              break;
            }
            for (c2 = h2; c2 < f2; c2++) if (b2[c2] > d2) {
              k2 = c2 + e2;
              break;
            }
          ...
          a2.prototype.generatePoints = function() {
            ...
            for (l2 = 0; l2 < f2; l2++) {
              ...
              } else (r2 = p2[v2]) || "undefined" === typeof a3[v2] || (p2[v2] = r2 = new e2().init(this, a3[v2], c2[l2]));
              r2 && (r2.index = g3 ? b2 + l2 : v2, n2[l2] = r2);
            }
            this.options.keys = k2;
            if (p2 && (f2 !== (m2 = p2.length) || g3)) for (l2 = 0; l2 < m2; l2++) l2 !== h2 || g3 || (l2 += f2), p2[l2] && (p2[l2].destroyElements(), p2[l2].plotX = void 0);
            this.data = p2;
            this.points = n2;
          ...
          a2.prototype.getExtremes = function(b2, a3) {
            ...
            for (g3 = 0; g3 < l2; g3++) {
              ...
              if (G && u2) if (G = p2.length) for (; G--; ) O(p2[G]) && (f2[m2++] = p2[G]);
              else f2[m2++] = p2;
            }
          ...
          a2.prototype.getFirstValidPoint = function(b2) {
            for (var a3 = b2.length, c2 = 0, d2 = null; null === d2 && c2 < a3; ) d2 = b2[c2], c2++;
            return d2;
          };
          a2.prototype.translate = function() {
            ...
            for (r2 = 0; r2 < k2; r2++) {
              ...
              if (h2.positiveValuesOnly && !h2.validatePositiveValue(I) || c2.positiveValuesOnly && !c2.validatePositiveValue(E2)) D2.isNull = true;
          ...
          a2.prototype.animate = function(b2) {
            ...
            if (b2 && c2) h2 = this.getClipBox(), k2 ? k2.attr("height", h2.height) : (h2.width = 0, f2 && (h2.x = a3.plotHeight), k2 = a3.renderer.clipRect(h2), a3.sharedClips[g3] = k2, n2 = a3.renderer.clipRect({ x: -99, y: -99, width: f2 ? a3.plotWidth + 199 : 99, height: f2 ? 99 : a3.plotHeight + 199 }), a3.sharedClips[g3 + "m"] = n2), c2.clip(k2), d2 && d2.clip(n2);
          ...
          a2.prototype.drawPoints = function(b2) {
            ...
            if (false !== e2.enabled || this._hasPointMarkers) for (k2 = 0; k2 < b2.length; k2++) {
              var m2 = b2[k2];
              ...
              if ((g3 && "undefined" === typeof q2.enabled || q2.enabled) && !m2.isNull && false !== m2.visible) {
                ...
                if (n2) if (q2 = this.pointAttribs(m2, c2 || !m2.selected ? void 0 : "select"), c2) d2 && n2.css({ fill: q2.fill });
                else n2[l2](q2);
                n2 && n2.addClass(m2.getClassName(), true);
              } else n2 && (m2.graphic = n2.destroy());
            }
          };
          ...
          a2.prototype.destroy = function(b2) {
            ...
            for (h2 = e2.length; h2--; ) (g3 = e2[h2]) && g3.destroy && g3.destroy();
          ...
          a2.prototype.applyZones = function() {
            ...
            if (d2.length && (f2 || h2) && k2 && "undefined" !== typeof k2.min) {
              ...
              this.clips = e2;
            } else b2.visible && (f2 && f2.show(), h2 && h2.show());
          };
          ...
          a2.prototype.searchKDTree = function(b2, a3, c2) {
            ...
            if (this.kdTree) return d2(b2, this.kdTree, a3, a3);
          };
          ...
          a2.prototype.drawTracker = function() {
            var b2 = this, a3 = b2.options, c2 = a3.trackByArea, d2 = [].concat(c2 ? b2.areaPath : b2.graphPath), e2 = b2.chart, f2 = e2.pointer, h2 = e2.renderer, g3 = e2.options.tooltip.snap, n2 = b2.tracker, m2 = function(a4) {
              if (e2.hoverSeries !== b2) b2.onMouseOver();
            ...
            n2 ? n2.attr({ d: d2 }) : b2.graph && (b2.tracker = h2.path(d2).attr({ visibility: b2.visible ? "inherit" : "hidden", zIndex: 2 }).addClass(c2 ? "highcharts-tracker-area" : "highcharts-tracker-line").add(b2.group), e2.styledMode || b2.tracker.attr({ "stroke-linecap": "round", "stroke-linejoin": "round", stroke: l2, fill: c2 ? l2 : "none", "stroke-width": b2.graph.strokeWidth() + (c2 ? 0 : 2 * g3) }), [
              ...
              }), a3.cursor && !e2.styledMode && b3.css({ cursor: a3.cursor }), k)) b3.on("touchstart", m2);
            }));
          ...
          a2.prototype.addPoint = function(b2, a3, c2, d2, e2) {
            ...
            var u2 = p2.x;
            var r2 = m2.length;
            if (this.requireSorting && u2 < m2[r2 - 1]) for (l2 = true; r2 && m2[r2 - 1] > u2; ) r2--;
            this.updateParallelArrays(p2, "splice", r2, 0, 0);
            this.updateParallelArrays(p2, r2);
            k2 && p2.name && (k2[u2] = p2.name);
            n2.splice(r2, 0, b2);
            if (l2 || this.processedData) this.data.splice(r2, 0, null), this.processData();
          ...
          a2.prototype.update = function(a3, d2) {
            ...
            k2 = false;
            if (A[r2]) {
              if (k2 = r2 !== e2.type, e2.remove(false, false, false, true), k2) if (Object.setPrototypeOf) Object.setPrototypeOf(
                e2,
                A[r2].prototype
              );
              else {
                m2 = Object.hasOwnProperty.call(e2, "hcEvents") && e2.hcEvents;
                for (w2 in n2) e2[w2] = void 0;
                u(e2, A[r2].prototype);
                m2 ? e2.hcEvents = m2 : delete e2.hcEvents;
              }
            } else b(17, true, f2, { missingModuleFor: r2 });
            p2.forEach(function(b2) {
              e2[b2] = p2[b2];
            });
            e2.init(f2, a3);
            if (z2 && this.points) {
              a3 = e2.options;
              if (false === a3.visible) l2.graphic = 1, l2.dataLabel = 1;
              ...
              h2 = 0;
              for (n2 = this.points; h2 < n2.length; h2++) (w2 = n2[h2]) && w2.series && (w2.resolveColor(), Object.keys(l2).length && w2.destroyElements(l2), false === a3.showInLegend && w2.legendItem && f2.legend.destroyItem(w2));
            }
            e2.initialType = g3;
            f2.linkSeries();
          ...
          a2.prototype.setState = function(b2, a3) {
            ...
            if (c2.state !== b2 && ([c2.group, c2.markerGroup, c2.dataLabelsGroup].forEach(function(a4) {
              ...
              if (h2[b2] && false === h2[b2].enabled) return;
              b2 && (k2 = h2[b2].lineWidth || k2 + (h2[b2].lineWidthPlus || 0), m2 = v(h2[b2].opacity, m2));
              if (e2 && !e2.dashstyle && O(k2)) for (d2 = { "stroke-width": k2 }, e2.animate(d2, g3); c2["zone-graph-" + n2]; ) c2["zone-graph-" + n2].animate(d2, g3), n2 += 1;
      ...
      K(g, "Extensions/ScrollablePlotArea.js", [
        ...
        t(x, "afterSetChartSize", function(a2) {
          ...
          if (!this.renderer.forExport) {
            ...
            } else d2 && (this.scrollablePixelsY = h = Math.max(0, d2 - this.chartHeight), l(h) && (this.scrollablePlotBox = this.renderer.scrollablePlotBox = e(this.plotBox), this.plotBox.height = this.plotHeight += h, this.inverted ? this.clipBox.width += h : this.clipBox.height += h, p = { 2: { name: "bottom", value: h } }));
        ...
        function(a, g2, x, F, C) {
          ...
          function l() {
            ...
            e2 && [a2, "-" + a2].forEach(function(a3) {
              for (var h2 = d2.length, g3, k2; h2--; ) g3 = d2[h2], f2 = b2.getStackIndicator(f2, g3, b2.index, a3), (k2 = (g3 = c2[a3] && c2[a3][g3]) && g3.points[f2.key]) && e2.call(b2, k2, g3, h2);
            });
          }
          function e(b2, a2, c2) {
          ...
          var m = a.getDeferredAnimation, k = x.series.prototype, p = C.addEvent, D = C.correctFloat, I = C.defined, E = C.destroyObjectProperties, L = C.fireEvent, y = C.isArray, c = C.isNumber, w = C.objectEach, f = C.pick, n = function() {
            ...
            b2.prototype.buildStacks = function() {
              ...
              for (e2 = 0; e2 < d2; e2++) a2[e2].modifyStacks();
              L(b3, "afterBuildStacks");
            };
            b2.prototype.cleanStacks = function() {
              if (this.oldStacks) var b3 = this.stacks = this.oldStacks;
              w(b3, function(b4) {
                w(b4, function(b5) {
        ...
        var A = this && this.__extends || /* @__PURE__ */ function() {
          var a2 = function(g3, r) {
            a2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(a3, e) {
              ...
              for (var d in e) e.hasOwnProperty(d) && (a3[d] = e[d]);
            };
            return a2(g3, r);
          };
        ...
        F = function(a2) {
          ...
          d.prototype.getGraphPath = function(a3) {
            ...
            var f = function(b2, d3, e2) {
              ...
              if (e2 || n2) {
                ...
                var m = b2[0] + e2;
                f2 = !!n2;
              } else !h && a3[d3] && a3[d3].isNull && (k = m = c);
            ...
            for (var n = 0, b = a3.length; n < b; ++n) {
              ...
              if (!u || e) e || f(n, n - 1, "left"), u && !h && e || (t2.push(a3[n]), r2.push({ x: n, plotX: z, plotY: q })), e || f(n, n + 1, "right");
            }
          ...
          d.prototype.getStackPoints = function(a3) {
            ...
            if (this.options.stacking) {
              for (var n = 0; n < a3.length; n++) a3[n].leftNull = a3[n].rightNull = void 0, x2[a3[n].x] = a3[n];
              r(A2, function(b2, a4) {
              ...
              h.forEach(function(a4, n2) {
                var k = 0, m, p;
                if (x2[a4] && !x2[a4].isNull) e.push(x2[a4]), [-1, 1].forEach(function(e2) {
                  var g4 = 1 === e2 ? "rightNull" : "leftNull", k2 = A2[h[n2 + e2]], l2 = 0;
                  if (k2) for (var q = f; 0 <= q && q < c; ) {
                    var u2 = y[q].index;
                    m = k2.points[u2];
      ...
      K(g, "Series/Column/ColumnSeries.js", [
        ...
        t = function(a2) {
          ...
          c.prototype.animate = function(a3) {
            ...
            if (a3) f.scaleY = 1e-3, a3 = h(b.toPixels(d2.threshold), b.pos, b.pos + b.len), e2 ? f.translateX = a3 - b.len : f.translateY = a3, c2.clipBox && c2.setClip(), c2.group.attr(f);
            else {
          ...
          c.prototype.drawPoints = function(a3) {
            ...
            a3.forEach(function(a4) {
              ...
              if (I(a4.plotY) && null !== a4.y) {
                ...
                if (h2 && k2) h2[n](E(g3));
                if (d2.borderRadius) h2[n]({ r: d2.borderRadius });
        ...
        (function(a2) {
          function g3(a3, c2, b, d2, e2) {
            ...
            if (m2 && k3) {
              ...
              if (b.shape && !p2) c2[e2 ? "attr" : "animate"]({ anchorX: k3[0], anchorY: k3[1] });
            }
          ...
          function y(a3, c2) {
            var b = [], d2;
            if (r(a3) && !r(c2)) b = a3.map(function(a4) {
              return e(
                a4,
                c2
              );
            });
            else if (r(c2) && !r(a3)) b = c2.map(function(b2) {
              return e(a3, b2);
            });
            else if (r(a3) || r(c2)) for (d2 = Math.max(a3.length, c2.length); d2--; ) b[d2] = e(a3[d2], c2[d2]);
            else b = e(a3, c2);
            return b;
          }
      ...
      K(g, "Series/CenteredUtilities.js", [
        ...
        (function(a2) {
          a2.getCenter = function() {
            ...
            for (l = 0; 4 > l; ++l) x2 = a3[l], d = 2 > l || 2 === l && /%$/.test(x2), a3[l] = t(x2, [m, k, r2, a3[2]][l]) + (d ? h : 0);
            a3[3] > a3[2] && (a3[3] = a3[2]);
      ...
      K(
        ...
        function(a, g2, x) {
          ...
          a(g2.prototype, { connectorShapes: { fixedOffset: function(a2, d, g3) {
            ...
            g3 = ["L", p, a2.y];
            h = true;
            if ("left" === e ? p > a2.x || p < d.x : p < a2.x || p > d.x) h = false;
            a2 = [["M", a2.x, a2.y]];
            h && a2.push(g3);
            a2.push(["L", d.x, d.y]);
            return a2;
      ...
      K(g, "Series/Pie/PieSeries.js", [
        ...
        var e = this && this.__extends || /* @__PURE__ */ function() {
          var a2 = function(d2, e2) {
            a2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(a3, d3) {
              ...
              for (var c in d3) d3.hasOwnProperty(c) && (a3[c] = d3[c]);
            };
            return a2(d2, e2);
          };
          return function(d2, e2) {
        ...
        l = function(a2) {
          ...
          g3.prototype.updateTotals = function() {
            ...
            this.total = g4;
            for (e2 = 0; e2 < c; e2++) b = a3[e2], b.percentage = 0 < g4 && (b.visible || !d2) ? b.y / g4 * 100 : 0, b.total = g4;
          };
        ...
        function(a, g2, x, F, C) {
          ...
          (function(g3) {
              ...
              a2.visible && (k3.enabled || a2._hasPointLabels) && (g4.forEach(function(a3) {
                ...
                if (g5) {
                  ...
                  for (Z = 0; Z < g5; Z++) {
                    ...
                    if (k3.justify) X = v.justify(C2, x3, A2);
                    else switch (k3.alignTo) {
                      case "connectors":
                ...
                if (F2 = h(W.connectorWidth, 1)) {
                  ...
                  if ((L = b2.dataLabel) && L._pos && b2.visible && 0 < b2.labelDistance) {
                    ...
                    if (c = !I) b2.connector = I = f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + b2.colorIndex + (b2.className ? " " + b2.className : "")).add(a2.dataLabelsGroup), f.styledMode || I.attr({ "stroke-width": F2, stroke: W.connectorColor || b2.color || "#666666" });
                    I[c ? "attr" : "animate"]({ d: b2.getConnectorPath() });
                    I.attr("visibility", V);
                  } else I && (b2.connector = I.destroy());
                }
              }));
            }
            function p() {
            ...
            function x2(a2) {
              ...
              if (!g4) {
                if (null !== e2[0]) var h2 = Math.max(c[2] - Math.max(a2[1], a2[3]), b);
                else h2 = Math.max(c[2] - a2[1] - a2[3], b), c[0] += (a2[3] - a2[1]) / 2;
      ...
      K(g, "Extensions/OverlappingDataLabels.js", [g["Core/Chart/Chart.js"], g["Core/Utilities.js"]], function(a, g2) {
        ...
        a.prototype.hideOverlappingLabels = function(a2) {
          ...
          for (k = 0; k < d; k++) if (l = a2[k]) l.oldOpacity = l.opacity, l.newOpacity = 1, l.absoluteBox = t2(l);
          ...
          var e2 = function() {
            ...
            a3.prototype.currentOptions = function(a4) {
              function d2(a5, g4, c, h) {
                var f;
                H(a5, function(a6, b) {
                  if (!h && -1 < e3.collectionsWithUpdate.indexOf(b) && g4[b]) for (a6 = r(a6), c[b] = [], f = 0; f < Math.max(a6.length, g4[b].length); f++) g4[b][f] && (void 0 === a6[f] ? c[b][f] = g4[b][f] : (c[b][f] = {}, d2(a6[f], g4[b][f], c[b][f], h + 1)));
                  else C(a6) ? (c[b] = F(a6) ? [] : {}, d2(a6, g4[b] || {}, c[b], h + 1)) : c[b] = "undefined" === typeof g4[b] ? null : g4[b];
                });
              }
              var e3 = this, g3 = {};
