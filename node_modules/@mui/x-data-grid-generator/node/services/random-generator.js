...
if (typeof DISABLE_CHANCE_RANDOM !== 'undefined' && DISABLE_CHANCE_RANDOM) {
  chance = new _chance.Chance(() => 0.5);
  chanceGuid = new _chance.Chance(42);
} else {
...
const randomInt = (min, max) => chance.integer({
  min,
  max
});
...
const randomId = () => chanceGuid.guid();
...
const randomName = exports.randomName = uniquenessHandler(() => chance.name());
